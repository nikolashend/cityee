...
<section class="guide-filters">
    <div class="container">
        <div class="guide-filter-pills">
            <a href="<?php echo e(route("{$locale}.guides")); ?>" data-filter="all" class="guide-filter-pill <?php echo e(!$activeCategory ? 'active' : ''); ?>">
                <?php echo e($locale === 'ru' ? 'Все' : ($locale === 'en' ? 'All' : 'Kõik')); ?>

            </a>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route("{$locale}.guides", ['category' => $cat])); ?>" data-filter="<?php echo e($cat); ?>" class="guide-filter-pill <?php echo e($activeCategory === $cat ? 'active' : ''); ?>">
        ...
        <?php else: ?>
            <div class="row g-4">
                <?php $__currentLoopData = $guides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-4 guide-card-item" data-category="<?php echo e($guide->category); ?>">
