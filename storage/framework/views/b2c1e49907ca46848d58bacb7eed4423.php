...
<div class="page-title">
  <div class="container">
    <h1 class="page-title__name"><?php echo e($t['heading'][$locale] ?? $t['heading']['en']); ?></h1>
    <p class="page-title__text"><?php echo e($t['subtitle'][$locale] ?? $t['subtitle']['en']); ?></p>
  </div>
</div>
    ...
    <div class="col-md-9 col-sm-9">
      <div class="content">
        ...
        <section class="dashboard-section" aria-labelledby="seo-scorecard">
          <h2 id="seo-scorecard" class="content__title"><?php echo e($t['seo_title'][$locale] ?? 'SEO Scorecard'); ?></h2>
          <div class="table-responsive">
            <table class="dashboard-table" role="table">
              <thead>
                <tr>
                  <th><?php echo e($t['category'][$locale]); ?></th>
                  <th><?php echo e($t['metric'][$locale]); ?></th>
                  <th><?php echo e($t['target'][$locale]); ?></th>
                  <th><?php echo e($t['status'][$locale]); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php $__currentLoopData = $seoMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><strong><?php echo e($row['cat']); ?></strong></td>
                  <td><?php echo e($row['metric']); ?></td>
        ...
        <section class="dashboard-section" aria-labelledby="ux-metrics" style="margin-top: 3rem;">
          <h2 id="ux-metrics" class="content__title"><?php echo e($t['ux_title'][$locale] ?? 'UX Metric Sheet'); ?></h2>
          <p><?php echo e($locale === 'ru' ? '10 эвристик юзабилити по Nielsen-Norman Group.' : ($locale === 'en' ? '10 usability heuristics by Nielsen-Norman Group.' : '10 kasutusheuristikat Nielsen-Norman Groupi järgi.')); ?></p>
          <div class="table-responsive">
            <table class="dashboard-table" role="table">
              <thead>
                <tr>
                  <th>#</th>
                  <th><?php echo e($t['heuristic'][$locale]); ?></th>
                  <th><?php echo e($t['finding'][$locale]); ?></th>
                  <th><?php echo e($t['priority'][$locale]); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php $__currentLoopData = $uxHeuristics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($h['id']); ?></td>
                  <td><strong><?php echo e($h['name'][$locale] ?? $h['name']['en']); ?></strong></td>
                  <td><?php echo e($h['finding'][$locale] ?? $h['finding']['en']); ?></td>
                  <td><?php echo e($h['priority']); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
        ...
        <section class="dashboard-section" aria-labelledby="eeat-assessment" style="margin-top: 3rem;">
          <h2 id="eeat-assessment" class="content__title"><?php echo e($t['eeat_title'][$locale] ?? 'EEAT Assessment'); ?></h2>
          <div class="table-responsive">
            <table class="dashboard-table" role="table">
              <thead>
                <tr>
                  <th><?php echo e($t['signal'][$locale]); ?></th>
                  <th><?php echo e($t['finding'][$locale]); ?></th>
                  <th><?php echo e($t['score'][$locale]); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php $__currentLoopData = $eeatSignals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><strong><?php echo e($sig['signal']); ?></strong></td>
                  <td><?php echo e($sig['desc'][$locale] ?? $sig['desc']['en']); ?></td>
                  <td><?php echo e($sig['score']); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
        ...
        <section class="dashboard-section" aria-labelledby="audit-templates" style="margin-top: 3rem;">
          <h2 id="audit-templates" class="content__title">
            <?php echo e($locale === 'ru' ? 'Шаблоны аудитов' : ($locale === 'en' ? 'Audit Templates' : 'Auditi mallid')); ?>

          </h2>
          <p><?php echo e($locale === 'ru' ? 'CityEE использует 4 профессиональных шаблона аудита:' : ($locale === 'en' ? 'CityEE uses 4 professional audit templates:' : 'CityEE kasutab 4 professionaalset auditi malli:')); ?></p>

          <?php $templates = config('cityee.audit_templates', []); ?>
          <div class="knowledge-grid">
            <?php $__currentLoopData = ['seo' => '🔍', 'geo' => '🤖', 'ux' => '⚡', 'eeat' => '🛡️']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(isset($templates[$key])): ?>
              <div class="knowledge-card">
                <span class="knowledge-card__icon"><?php echo e($icon); ?></span>
                <h3 class="knowledge-card__title"><?php echo e($templates[$key]['name']); ?></h3>
                <p class="knowledge-card__desc"><?php echo e($templates[$key]['description']); ?></p>
                <p class="knowledge-card__desc"><strong><?php echo e(count($templates[$key]['categories'] ?? [])); ?></strong> <?php echo e($locale === 'ru' ? 'категорий' : ($locale === 'en' ? 'categories' : 'kategooriat')); ?></p>
              </div>
              <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        ...
        <section class="guide-cta" style="margin-top: 3rem;" aria-label="CTA">
          <h3><?php echo e($locale === 'ru' ? 'Хотите полный SEO-аудит?' : ($locale === 'en' ? 'Want a full SEO audit?' : 'Soovid täielikku SEO-auditi?')); ?></h3>
          <p><?php echo e($locale === 'ru' ? 'Получите комплексный аудит: технический SEO + Core Web Vitals + EEAT + GEO за 24 часа.' : ($locale === 'en' ? 'Get a comprehensive audit: technical SEO + Core Web Vitals + EEAT + GEO within 24 hours.' : 'Saa terviklik audit: tehniline SEO + Core Web Vitals + EEAT + GEO 24 tunni jooksul.')); ?></p>
          <a href="https://wa.me/3725113411" class="btn-v3" rel="nofollow noopener" target="_blank">
            <?php echo e($locale === 'ru' ? 'Заказать аудит через WhatsApp' : ($locale === 'en' ? 'Order audit via WhatsApp' : 'Telli audit WhatsAppi kaudu')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nikol\Documents\projects\cityee-laravel\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>