    ...
    <div class="container" style="max-width:960px">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1.25rem">
            ...
            <div style="background:#fff;padding:1.5rem;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.05);border-left:3px solid var(--ce-accent,#4ecdc4)">
                <div style="font-size:1.5rem;margin-bottom:.5rem"><?php echo e($item['icon']); ?></div>
                <h3 style="font-size:1rem;margin:0 0 .5rem;font-weight:700"><?php echo e($item['title']); ?></h3>
                <p style="font-size:.9rem;opacity:.75;margin:0;line-height:1.6"><?php echo e($item['text']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
<?php /**PATH C:\Users\nikol\Documents\projects\cityee-laravel\resources\views/partials/ai-recommends.blade.php ENDPATH**/ ?>