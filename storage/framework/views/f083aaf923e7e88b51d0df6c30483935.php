...
<section class="phase3-ai-answer" style="padding:2.5rem 0;background:#f8fafb">
  <div class="container" style="max-width:800px">
    <div style="background:#fff;border-left:4px solid #4ecdc4;border-radius:8px;padding:1.5rem 2rem;box-shadow:0 2px 8px rgba(0,0,0,.06)">
      <h2 style="font-size:1.2rem;margin:0 0 .75rem;color:#1a1a2e"><?php echo e($hub['ai_answer']['title']); ?></h2>
      <p style="margin:0;line-height:1.7;font-size:1rem;color:#333"><?php echo e($hub['ai_answer']['text']); ?></p>
    </div>
  </div>
</section>
<?php endif; ?>
