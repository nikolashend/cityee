...
<?php $__env->startSection('title', $district['meta_title'] ?? ''); ?>
<?php $__env->startSection('description', $district['meta_description'] ?? ''); ?>
...
<?php echo \App\Support\JsonLd::webPage($district['meta_title'] ?? '', url()->current(), $district['meta_description'] ?? ''); ?>
...
<?php if(!empty($district['ai_answer'])): ?>
<section class="phase3-ai-answer" style="padding:2.5rem 0;background:#f8fafb">
  <div class="container" style="max-width:800px">
    <div style="background:#fff;border-left:4px solid #4ecdc4;border-radius:8px;padding:1.5rem 2rem;box-shadow:0 2px 8px rgba(0,0,0,.06)">
      <h2 style="font-size:1.15rem;margin:0 0 .75rem;color:#1a1a2e">Короткий ответ: продажа квартиры в <?php echo e($district['name']); ?></h2>
      <p style="margin:0;line-height:1.7;font-size:1rem;color:#333"><?php echo e($district['ai_answer']); ?></p>
    </div>
  </div>
</section>
<?php endif; ?>
...
<div class="container" style="padding:2.5rem 0">
  <div class="row">
    <div class="col-md-8 col-sm-8">
      <?php $__currentLoopData = $district['sections'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-4 col-sm-4">
      <div style="background:var(--ce-warm-bg,#faf8f5);padding:1.5rem;border-radius:8px;margin-bottom:2rem">
        ...
        <ul style="list-style:none;padding:0;margin:0">
          <?php $allDistricts = config('cityee-phase3.districts', []); ?>
          <?php $__currentLoopData = $allDistricts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dSlug => $dData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($dSlug !== $slug): ?>
            <li style="margin-bottom:.6rem">
              <a href="<?php echo e(url('/ru/tallinn/' . $dSlug)); ?>/">→ <?php echo e($dData['name'] ?? ucfirst($dSlug)); ?></a>
            </li>
            <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
...
<?php if(!empty($district['faq'])): ?>
<?php echo $__env->make('partials.faq', ['faq' => $district['faq'], 'faqTitle' => 'FAQ'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>


<section style="padding:3rem 0;text-align:center;background:var(--ce-warm-bg,#faf8f5)">
  <div class="container">
    <h2>Хотите продать квартиру в <?php echo e($district['name']); ?>?</h2>
...
<div class="container" style="padding:1rem 0">
  <p><small>📍 CityEE — Таллинн, <?php echo e($district['name']); ?>, Эстония. Viru väljak 2, Tallinn 10111.</small></p>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nikol\Documents\projects\cityee-laravel\resources\views/pages/phase3-district.blade.php ENDPATH**/ ?>