...
<div class="page-title page-title--banks">
  <div class="container">
...
<div class="container">
  <article class="about about--page">
    ...
    <div class="row">
      <div class="col-xs-12">
        <x-webp-img class="about__mobile-img" src="/assets/templates/offshors/img/about-foto-mobile.jpg" alt="CITY EE — konsultatsioon" width="600" height="400" />
      </div>
      ...
      <div class="col-sm-6 col-xs-12">
        <x-webp-img class="about__desctop-img" src="/assets/templates/offshors/img/about-foto.jpg" alt="CITY EE — konsultatsioon" width="555" height="740" />
      </div>
    </div>
  </article>
</div>
