...
<div class="container">
  <article class="about">
    ...
    <div class="row">
      <div class="col-xs-12">
        <x-webp-img class="about__mobile-img" src="/assets/templates/offshors/img/about-foto-mobile.jpg" alt="CITY EE — маклер по недвижимости" width="600" height="400" />
      </div>
      ...
      <div class="col-sm-6 col-xs-12">
        <x-webp-img class="about__desctop-img" src="/assets/templates/offshors/img/about-foto.jpg" alt="CITY EE — маклер по недвижимости" width="555" height="740" />
      </div>
    </div>
  </article>
</div>
...
<div>
  ...
  <div class="text-center" style="margin-bottom: 7px;"><x-webp-img src="/assets/templates/offshors/img/ap1.png" width="240" height="320" alt="Александр Примаков — маклер CITY EE Таллинн" /></div>
